...
namespace E.m.a.r.t.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [RegularExpression("[1-9][0-9]{3}-[0-9]{3} [A-Za-z ]+", ErrorMessage = "No código postal só são aceites algarismos e letras.")]
            ...
            [RegularExpression("(([+]|00)[0-9]{1,5})?[1-9][0-9]{5,10}", ErrorMessage = "Escreva um número de telefone válido.")]
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    _context.Utilizadores.Add(new Models.Utilizadores
                    {
                        ...
                        UserName = user.UserName // liga ao Identity
                    });
